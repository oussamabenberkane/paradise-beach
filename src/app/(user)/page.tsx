...
import { useCountUp } from "@/app/showcase/_shared/hooks";
import { formatDate, formatCurrency, formatTime } from "@/lib/utils";

/* ─── Hero animation constants (copied verbatim from SunsetStripV2.tsx) ─── */
...
export default function HomePage() {
  ...
  const { topGrid, stats, next } = data;

  return (
    <>
      <Hero />
      <DarkDashboard topGrid={topGrid} stats={stats} next={next} />
    </>
  );
}
    ...
    >
      <div className="ssv2-sticky">
        <img
          ...
          loading="eager"
          style={{
            background: "linear-gradient(135deg, #0A0A0C, #1C2B4A)",
          }}
        />
        <img
          className="ssv2-day"
          ...
          loading="eager"
          style={{
            background: "linear-gradient(135deg, #FFB627, #E8580C)",
          }}
        />
        ...
        <div className="ssv2-content">
          <span className="ssv2-eyebrow">★ SUMMER &apos;26 · TWELVE NIGHTS ★</span>
...
function DarkDashboard({
  ...
  stats: ReturnType<typeof getShowcaseData>["stats"];
    ...
    <div className="ss-dashboard">
      ...
      <header className="ss-sticky-nav">
        ...
        <nav className="ss-sticky-pills" aria-label="Festival sections">
          <Link href="/events" className="ss-sticky-pill">Events</Link>
          <Link href="/singers" className="ss-sticky-pill">Artists</Link>
          <Link href="/my-tickets" className="ss-sticky-pill">Tickets</Link>
          <Link href="/chat" className="ss-sticky-pill">Chat</Link>
        </nav>
      ...
      <section className="ss-stats" aria-label="Season totals">
        ...
        <StatBlock label="REVENUE" value={Math.round(stats.totalRevenue / 1000)} suffix="K€" />
      </section>
      ...
      <section className="ss-section">
        ...
        <div style={{ textAlign: "center", marginTop: "2rem" }}>
          <Link href="/events" className="ss-chat-cta" style={{ display: "inline-flex" }}>
            View All Events
      ...
      <section className="ss-chat">
        <div className="ss-chat-box">
          ...
          <div className="ss-chat-prompts">
            {["What&apos;s playing tonight?", "Cheapest reggae night", "VIP nights in July"].map((p) => (
